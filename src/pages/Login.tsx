...
export default function Login() {
  ...
  const { setUser, setAccessToken, accessToken } = useAuth();
  ...
  return (
    <main className="font-departure relative min-h-screen overflow-hidden bg-[#0a0612] text-[#f7f0ff]">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
            ...
            <div className="bg-[#1a0a2e] p-6 pt-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-right">
                  <button
                    type="button"
                    className="text-[10px] font-bold uppercase tracking-widest text-[#664488] transition-colors hover:text-[#ff00ff]"
                  >
                    Forgot Password?
                  </button>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group relative w-full rounded-none border-2 border-[#00ffff] bg-[#0a1520] py-4 text-center font-black uppercase tracking-widest text-white transition-all duration-100 hover:bg-[#00ffff20] disabled:opacity-50"
                  style={{
              ...
              <Link
                to="/signup"
                className="group relative block w-full rounded-none border-2 border-[#ff00ff] bg-[#200a18] py-3 text-center font-bold uppercase tracking-widest text-[#ff8cf7] transition-all duration-100 hover:bg-[#ff00ff20]"
                style={{
                  boxShadow: "4px 4px 0 #ff00ff40, inset 0 0 15px #ff00ff08",
                }}
              >
                <span
          ...
          <p className="mt-6 text-center text-[10px] text-[#664488] tracking-widest">
            RETURNING PLAYER • ENTER CREDENTIALS
          </p>
        </div>
      </section>
      ...
      <div className="pointer-events-none absolute bottom-4 left-4 right-4 flex justify-between text-[10px] text-[#332244]">
        <span>STATUS: AWAITING_AUTH</span>
